...
im = cv2.imread('C:/Users/Mohamed/Documents/2ASicom/Sudoku-robot/Firmware/images/sud24.jpeg')#,cv2.IMREAD_GRAYSCALE)
...
##            break
I = (img>(img.mean()*1.1)) #juste pour rehausser les lignes qui peuvent ne pas être en noir(ca marche mais pas top)
stat = ExtractBoxes(I*imB,connexity = 8,thresh=(lx/18,ly/18,lx/3,ly/3))
tri_stat(stat,lx/18)
##fig,axis = plt.subplots(9,9)
##fig.subplots_adjust(hspace=0.3, wspace=0.3)
imBox = ExtractBoxImage(stat,img,(28,28),cv2.INTER_CUBIC)
imBox1 = ExtractBoxImage(stat,img,(28,28),cv2.INTER_AREA)
imBox2 = ExtractBoxImage(stat,img,(28,28),cv2.INTER_LINEAR)
imBox3 = ExtractBoxImage(stat,img,(28,28),cv2.INTER_LANCZOS4)
